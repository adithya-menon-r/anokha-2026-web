...
const brand_icons = {
    facebook : <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook-icon lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>,
        ...
        <div className="pl-4 pr-4 pb-4 block">
            ...
            <div className="mt-3 md:pl-10">
                ...
                <div className="flex items-center">
                    ...
                    <ArrowUpRight size={16} className="ml-1 text-gray-500 hover:scale-125" />
                </div>
                </div>
            </div>
            ...
            <div className="mt-3 text-white block space-y-1 md:pl-12">
                ...
                return (
                    ...
                    >
                    {isActive && <Circle size={6} className="-ml-4 mr-1" />}
