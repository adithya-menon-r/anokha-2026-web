              ...
              <div className="space-y-8">
                ...
                <div className="text-center lg:text-left">
                  <a
                    href="#register"
                    id="register"
                    className="inline-flex items-center gap-3 px-8 sm:px-10 py-4 sm:py-5 text-base sm:text-lg font-bold text-[#0a0a0f] bg-gradient-to-r from-orange-400 to-amber-500 rounded-full hover:scale-105 transition-all duration-300 hover:shadow-[0_0_50px_rgba(251,146,60,0.8)] group"
                  >
