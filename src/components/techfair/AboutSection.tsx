        ...
        <div className="relative bg-gradient-to-br from-gray-900/50 via-orange-950/10 to-gray-900/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl">
          ...
          >
            <p>
              ...
              that brings together students from colleges and schools across the
              country to showcase innovation, creativity, and applied
              technology.
            </p>
            ...
            <p>
              ...
              exposure, and professional growth through meaningful interaction.
            </p>
            ...
            <p>
              ...
              . Over the years, it has evolved into a vibrant space where ideas
              move beyond concepts and take shape as working models, prototypes,
