    ...
    <section className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8 fade-in-section">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-orange-300 to-amber-400 bg-clip-text text-transparent">
          ...
          {[
            {
              ...
              description:
                'Top ideas nominated to National Innovation Repository',
            },
            {
              icon: (
                <svg
              ...
              title: 'Certificates',
              description:
                'For all participating teams in TechFair & Pre-Events',
            },
            {
              icon: (
                <svg
            ...
            },
            {
              ...
              title: 'Prize Pool',
              description: 'Attractive cash prizes and awards (Details TBA)',
            },
          ].map((item, i) => (
            <div
              key={i}
