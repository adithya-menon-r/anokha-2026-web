...
module.exports = {
  darkMode: ["class"],
  content: ['./src/**/*.{js,ts,jsx,tsx}', './examples/**/*.{js,ts,jsx,tsx}', "./src/components/**/*.{js,ts,jsx,tsx,mdx}", "./src/app/**/*.{js,ts,jsx,tsx,mdx}",],
  theme: {
    extend: {
      colors: {
      ...
      boxShadow: {
        ...
        'neon-orange': '0 0 5px rgba(255, 116, 37, 0.5), 0 0 15px rgba(255, 116, 37, 0.3)',
        'portal-glow': '0 0 40px rgba(255, 85, 34, 0.8), 0 0 80px rgba(255, 85, 34, 0.4)',
        'glass': '0 4px 20px 0 rgba(0, 0, 0, 0.3)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'portal-radial': 'radial-gradient(circle at center, #FF5522, transparent 70%)',
        'mascot-gradient': 'linear-gradient(135deg, rgba(255, 116, 37, 0.2), rgba(0, 102, 255, 0.2))',
      },
      animation: {
